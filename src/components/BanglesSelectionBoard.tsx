...
export function BanglesSelectionBoard({
  ...
  const selections: Selection[] = useMemo(() => {
    return Object.entries(quantities)
      ...
      .sort((a, b) => {
        const colorOrder =
          colors.findIndex((c) => c.name === a.color) -
          colors.findIndex((c) => c.name === b.color);
  ...
  const getColorHex = (colorName: string) => {
    return colors.find((c) => c.name === colorName)?.hex || "#888888";
  };
    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-8 text-muted-foreground text-sm">
          <p>Karnataka Bangles Stores • Premium Glass Bangles Since 1985</p>
