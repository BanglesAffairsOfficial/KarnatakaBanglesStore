    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <Badge className="mb-4 mx-auto">EST. 1985</Badge>
          <h1 className="text-5xl font-display font-bold text-foreground mb-4">
            Karnataka Bangles Stores
          </h1>
          <p className="text-xl text-muted-foreground mb-6">
            Celebrating 40 years of craftsmanship, tradition, and elegance
          </p>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From our humble beginnings in Bangalore to becoming a trusted name across India, we've been committed to bringing authentic, high-quality bangles to every celebration and occasion.
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="p-8 bg-secondary">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    In 1985, a small shop opened on Commercial Street in Bangalore with a simple mission: to bring the finest glass bangles to customers at affordable prices.
                  </p>
                  <p>
